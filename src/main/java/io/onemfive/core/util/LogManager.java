...
public class LogManager implements Flushable {
    ...
    private synchronized void startLogWriter() {
        ...
        Thread t = new OOMHandledThread(_writer, "LogWriter");
        t.setDaemon(true);
        t.start();
    }
    ...
    void addRecord(LogRecord record) {
        if ((!_context.isConsciousContext()) && _writer == null)
            startLogWriter();
    ...
    private void loadConfig() {
        ...
        try {
            ...
            _configLastRead = new Date().getTime();
 ...
 *****/
    ...
    private class ShutdownHook extends AppThread {
