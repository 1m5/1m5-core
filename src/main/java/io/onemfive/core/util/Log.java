...
public class Log {
     ...
     *  Use OneMFiveAppContext.getGlobalContext().logManager().getLog(cls)
     */
    public Log(Class<?> cls) {
        this(OneMFiveAppContext.getInstance().logManager(), cls, null);
        _manager.addLog(this);
    }

    /**
     *  Warning - not recommended.
     *  Use OneMFiveAppContext.getGlobalContext().logManager().getLog(name)
     */
    public Log(String name) {
        this(OneMFiveAppContext.getInstance().logManager(), null, name);
        _manager.addLog(this);
    }
