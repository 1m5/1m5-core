...
package io.onemfive.core.util.getopt;
 ...
 */
    ...
    private ResourceBundle _messages = ResourceBundle.getBundle(
            "io/synapticcelerity/core/util/getopt/MessagesBundle", Locale.getDefault());
...
/**************************************************************************/
           ...
           LongOpt[] long_options, boolean long_only)
    {
        ...
        else
        {
            ...
            _messages = ResourceBundle.getBundle("io/synapticcelerity/core/util/getopt/MessagesBundle",
                    Locale.US);
        }
