...
package io.onemfive.core.util.http.conn.ssl;
...
import io.onemfive.core.util.http.conn.util.PublicSuffixMatcher;
/**
...
public final class DefaultHostnameVerifier implements HostnameVerifier {
    ...
    private final Log log = OneMFiveAppContext.getInstance().logManager().getLog(getClass());
    ...
    public final void verify(
        ...
        final boolean ipv4 = io.onemfive.core.util.http.conn.util.InetAddressUtils.isIPv4Address(host);
        final boolean ipv6 = io.onemfive.core.util.http.conn.util.InetAddressUtils.isIPv6Address(host);
